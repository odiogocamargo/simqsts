...
serve(async (req) => {
  ...
  try {
    ...
    const taxonomyPrompt = [
      ...
      "7. O campo statement deve vir limpo e completo, sem prefixos desnecessários.",
        ...
        messages: [
          ...
          },
          {
            ...
            content: [
              {
                type: "text",
                text: "Analise esta imagem e extraia todas as questões visíveis para pré-preenchimento do formulário de cadastro. Se houver várias questões, retorne todas.",
              },
              {
                type: "image_url",
                image_url: {
