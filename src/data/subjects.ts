...
export const subjects: Subject[] = [
  ...
  },
  {
    ...
    contents: [
      {
        id: "introducao-filosofia",
        name: "Introdução à Filosofia",
        topics: [
          { id: "origem-filosofia-grecia", name: "Origem da filosofia na Grécia Antiga" },
          { id: "passagem-mito-logos", name: "Passagem do mito ao logos" },
          { id: "principais-campos-filosofia", name: "Principais campos da filosofia (ética, política, epistemologia, estética, metafísica e lógica)" },
          { id: "importancia-reflexao-critica", name: "Importância da reflexão crítica e do pensamento racional" },
        ],
      },
      {
        id: "filosofia-antiga",
        ...
        topics: [
          { id: "pre-socraticos", name: "Pré-socráticos: a busca pela arché (Tales, Heráclito, Parmênides, Demócrito, Pitágoras)" },
          { id: "socrates-metodo-maieutico", name: "Sócrates e o método maiêutico" },
          { id: "platao-mundo-ideias", name: "Platão e o mundo das ideias" },
          { id: "aristoteles-logica-etica-politica", name: "Aristóteles e a lógica, ética e política" },
          { id: "filosofia-helenistica", name: "Filosofia helenística (estoicismo, epicurismo e ceticismo)" },
        ],
      },
      {
        ...
        topics: [
          { id: "relacao-fe-razao", name: "Relação entre fé e razão" },
          { id: "patristica-santo-agostinho", name: "Patrística (Santo Agostinho e a influência do cristianismo)" },
          { id: "escolastica-sao-tomas-aristoteles", name: "Escolástica (São Tomás de Aquino e Aristóteles)" },
          { id: "filosofia-islamica-judaica", name: "Filosofia islâmica e judaica" },
          { id: "pensamento-religioso-papel-igreja", name: "Pensamento religioso e o papel da Igreja" },
        ],
      },
      {
        ...
        topics: [
          { id: "humanismo-renascimento", name: "Humanismo e Renascimento" },
          { id: "racionalismo-descartes-leibniz-spinoza", name: "Racionalismo (Descartes, Leibniz e Spinoza)" },
          { id: "empirismo-bacon-locke-hume", name: "Empirismo (Bacon, Locke, Hume)" },
          { id: "criticismo-kantiano", name: "Criticismo kantiano" },
          { id: "contratualismo-teoria-politica", name: "Contratualismo e teoria política moderna (Hobbes, Locke e Rousseau)" },
          { id: "iluminismo-valorizacao-razao", name: "Iluminismo e a valorização da razão" },
        ],
      },
      {
        ...
        topics: [
          { id: "idealismo-alemao-hegel-dialetica", name: "Idealismo alemão (Hegel e a dialética)" },
          { id: "positivismo-comte", name: "Positivismo (Comte)" },
          { id: "materialismo-historico-marx-engels", name: "Materialismo histórico (Marx e Engels)" },
          { id: "existencialismo-kierkegaard-sartre-camus", name: "Existencialismo (Kierkegaard, Sartre e Camus)" },
          { id: "filosofia-linguagem-wittgenstein", name: "Filosofia da linguagem (Wittgenstein)" },
          { id: "escola-frankfurt-adorno-horkheimer-marcuse", name: "Escola de Frankfurt (Adorno, Horkheimer e Marcuse)" },
          { id: "pos-modernidade-pensamento-critico", name: "Pós-modernidade e pensamento crítico" },
        ],
      },
      {
        id: "etica-moral",
        name: "Ética e Moral",
        topics: [
          { id: "conceitos-etica-moral-valores", name: "Conceitos de ética, moral e valores" },
          { id: "virtude-aristoteles", name: "Virtude em Aristóteles" },
          { id: "etica-kantiana-dever", name: "Ética kantiana do dever" },
          { id: "utilitarismo-hedonismo", name: "Utilitarismo e hedonismo" },
          { id: "liberdade-responsabilidade", name: "Liberdade e responsabilidade" },
          { id: "dilemas-morais-contemporaneos", name: "Dilemas morais contemporâneos (bioética, tecnologia, meio ambiente)" },
        ],
      },
      {
        ...
        topics: [
          { id: "estado-poder-justica", name: "Estado, poder e justiça" },
          { id: "teoria-contrato-social", name: "Teoria do contrato social (Hobbes, Locke e Rousseau)" },
          { id: "maquiavel-politica-realista", name: "Maquiavel e a política realista" },
          { id: "critica-capitalismo-hannah-arendt", name: "Crítica ao capitalismo: Hannah Arendt e a ação política" },
          { id: "democracia-cidadania-direitos", name: "Democracia, cidadania e direitos humanos" },
        ],
      },
      {
        id: "epistemologia-teoria-conhecimento",
        name: "Epistemologia (Teoria do Conhecimento)",
        topics: [
          { id: "tipos-fontes-conhecimento", name: "Tipos e fontes do conhecimento (empírico, racional e intuitivo)" },
          { id: "verdade-crenca", name: "Verdade e crença" },
          { id: "ceticismo-dogmatismo", name: "Ceticismo e dogmatismo" },
          { id: "racionalismo-empirismo", name: "Racionalismo x empirismo" },
          { id: "kant-sintese-experiencia-razao", name: "Kant e a síntese entre experiência e razão" },
          { id: "ciencia-conhecimento-filosofico", name: "Ciência e conhecimento filosófico" },
        ],
      },
      {
        id: "logica-argumentacao",
        name: "Lógica e Argumentação",
        topics: [
          { id: "conceito-logica-principios", name: "Conceito de lógica; princípios do pensamento (identidade, não contradição e terceiro excluído)" },
          { id: "raciocinio-dedutivo-indutivo", name: "Raciocínio dedutivo e indutivo" },
          { id: "falacias-argumentos-invalidos", name: "Falácias e argumentos inválidos" },
          { id: "logica-simbolica-raciocinio-critico", name: "Lógica simbólica e raciocínio crítico" },
        ],
      },
      {
        id: "estetica-filosofia-arte",
        name: "Estética e Filosofia da Arte",
        topics: [
          { id: "conceito-beleza-arte", name: "Conceito de beleza e arte" },
          { id: "arte-imitacao-expressao", name: "Arte como imitação e expressão" },
          { id: "estetica-classica-platao-aristoteles", name: "Estética clássica (Platão e Aristóteles)" },
          { id: "arte-moderna-pos-moderna", name: "Arte moderna e pós-moderna" },
          { id: "funcao-social-arte", name: "Função social da arte" },
          { id: "industria-cultural-critica-estetica", name: "Indústria cultural e crítica estética contemporânea" },
        ],
      },
      {
        id: "filosofia-ciencia-tecnologia",
        name: "Filosofia da Ciência e da Tecnologia",
        topics: [
          { id: "ciencia-moderna-metodo-cientifico", name: "A ciência moderna e o método científico" },
          { id: "limites-eticos-ciencia", name: "Limites éticos da ciência" },
          { id: "revolucoes-cientificas-kuhn-popper", name: "Revoluções científicas (Kuhn e Popper)" },
          { id: "tecnologia-sociedade", name: "Tecnologia e sociedade" },
          { id: "inteligencia-artificial-responsabilidade-etica", name: "Inteligência artificial e responsabilidade ética no uso da tecnologia" },
        ],
      },
      {
        id: "filosofia-linguagem-comunicacao",
        name: "Filosofia da Linguagem e da Comunicação",
        topics: [
          { id: "linguagem-forma-pensamento", name: "Linguagem como forma de pensamento" },
          { id: "signo-simbolo-significado", name: "Signo, símbolo e significado" },
          { id: "analise-linguagem-wittgenstein-saussure-bakhtin", name: "Análise da linguagem (Wittgenstein, Saussure, Bakhtin)" },
          { id: "discurso-poder-ideologia", name: "Discurso, poder e ideologia" },
          { id: "comunicacao-manipulacao-midiatica", name: "Comunicação e manipulação midiática" },
        ],
      },
      {
        id: "existencia-liberdade-sentido-vida",
        name: "Existência, Liberdade e Sentido da Vida",
        topics: [
          { id: "existencialismo-liberdade-individual", name: "Existencialismo e liberdade individual" },
          { id: "angustia-autenticidade", name: "Angústia e autenticidade" },
          { id: "relacao-fe-razao-existencia", name: "Relação entre fé, razão e existência" },
          { id: "sentido-vida-modernidade", name: "Sentido da vida na modernidade" },
          { id: "etica-responsabilidade-alteridade-levinas", name: "Ética da responsabilidade e alteridade (Levinas)" },
        ],
      },
      {
        id: "cidadania-sociedade-globalizacao",
        name: "Cidadania, Sociedade e Globalização",
        topics: [
          { id: "filosofia-direitos-humanos", name: "Filosofia e direitos humanos" },
          { id: "justica-social-equidade", name: "Justiça social e equidade" },
          { id: "multiculturalismo-diversidade", name: "Multiculturalismo e diversidade" },
          { id: "alienacao-consumo", name: "Alienação e consumo" },
          { id: "globalizacao-etica-planetaria", name: "Globalização e ética planetária" },
          { id: "filosofia-sustentabilidade", name: "Filosofia e sustentabilidade" },
        ],
      },
    ],
  },
  {
    ...
    contents: [
      {
        id: "introducao-sociologia-metodo",
        name: "Introdução à Sociologia e Método Científico",
        topics: [
          { id: "surgimento-sociologia", name: "Surgimento da Sociologia: sociedade e cultura" },
          { id: "distincao-senso-comum-conhecimento", name: "Distinção entre senso comum e conhecimento científico" },
          { id: "objeto-metodo-sociologia", name: "Objeto e método da sociologia" },
          { id: "papel-sociologia-mundo-contemporaneo", name: "Papel da sociologia na compreensão do mundo contemporâneo" },
        ],
      },
      {
        id: "fundadores-sociologia",
        name: "Os Fundadores da Sociologia",
        topics: [
          { id: "auguste-comte-positivismo", name: "Auguste Comte e o positivismo" },
          { id: "emile-durkheim-fatos-sociais", name: "Émile Durkheim e os fatos sociais" },
          { id: "karl-marx-materialismo-historico", name: "Karl Marx e o materialismo histórico" },
          { id: "max-weber-acao-social", name: "Max Weber e a ação social" },
          { id: "comparacao-abordagens-classicas", name: "Comparação entre as abordagens clássicas" },
        ],
      },
      {
        ...
        topics: [
          { id: "conceito-cultura", name: "Conceito de cultura" },
          { id: "etnocentrismo-relativismo-cultural", name: "Etnocentrismo e relativismo cultural" },
          { id: "aculturacao-multiculturalismo", name: "Aculturação e multiculturalismo" },
          { id: "industria-cultural-cultura-massa", name: "Indústria cultural e cultura de massa (Adorno e Horkheimer)" },
          { id: "identidade-cultural-globalizacao", name: "Identidade cultural e globalização" },
        ],
      },
      {
        id: "estrutura-social-desigualdade",
        name: "Estrutura Social e Desigualdade",
        topics: [
          { id: "classes-estratificacao-social", name: "Classes e estratificação social" },
          { id: "mobilidade-social", name: "Mobilidade social" },
          { id: "desigualdade-genero-raca-renda", name: "Desigualdade de gênero, raça e renda" },
          { id: "meritocracia-exclusao-social", name: "Meritocracia e exclusão social" },
          { id: "capitalismo-trabalho-alienacao-marx", name: "Capitalismo, trabalho e alienação (Marx)" },
        ],
      },
      {
        id: "socializacao-interacao-social",
        name: "Socialização e Interação Social",
        topics: [
          { id: "processo-socializacao-primaria-secundaria", name: "Processo de socialização (primária e secundária)" },
          { id: "agentes-socializadores", name: "Agentes socializadores (família, escola, mídia, religião)" },
          { id: "papeis-status-sociais", name: "Papéis e status sociais" },
          { id: "controle-social-sancoes", name: "Controle social e sanções" },
          { id: "desvio-conformidade", name: "Desvio e conformidade" },
        ],
      },
      {
        id: "instituicoes-sociais",
        name: "Instituições Sociais",
        topics: [
          { id: "estrutura-funcao-instituicoes", name: "Estrutura e função das instituições sociais" },
          { id: "papel-familia-escola-estado-religiao", name: "Papel da família, escola, Estado e religião" },
          { id: "transformacoes-instituicoes-mundo-contemporaneo", name: "Transformações nas instituições no mundo contemporâneo" },
          { id: "crise-instituicoes-tradicionais", name: "Crise das instituições tradicionais" },
        ],
      },
      {
        id: "trabalho-industria-capitalismo",
        name: "Trabalho, Indústria e Capitalismo",
        topics: [
          { id: "trabalho-antiguidade-modernidade", name: "O trabalho na Antiguidade e na Modernidade" },
          { id: "revolucao-industrial-consequencias", name: "Revolução Industrial e suas consequências" },
          { id: "taylorismo-fordismo-toyotismo", name: "Taylorismo, Fordismo e Toyotismo" },
          { id: "globalizacao-novas-formas-trabalho", name: "Globalização e novas formas de trabalho (precariado, economia digital)" },
        ],
      },
      {
        id: "poder-politica-estado",
        name: "Poder, Política e Estado",
        topics: [
          { id: "poder-dominacao-autoridade-weber", name: "Poder, dominação e autoridade (Weber)" },
          { id: "estado-soberania", name: "Estado e soberania" },
          { id: "ideologia-hegemonia-gramsci", name: "Ideologia e hegemonia (Gramsci)" },
          { id: "democracia-cidadania", name: "Democracia e cidadania" },
          { id: "movimentos-sociais-participacao-politica", name: "Movimentos sociais e participação política" },
        ],
      },
      {
        id: "movimentos-sociais-cidadania",
        name: "Movimentos Sociais e Cidadania",
        topics: [
          { id: "movimentos-operarios-sindicais", name: "Movimentos operários e sindicais" },
          { id: "lutas-feministas-antirracistas", name: "Lutas feministas e antirracistas" },
          { id: "ambientalismo-direitos-civis", name: "Ambientalismo e direitos civis" },
          { id: "novos-movimentos-sociais", name: "Novos movimentos sociais (identitários, LGBTQIA+, digitais)" },
        ],
      },
      {
        id: "juventude-sociedade-contemporanea",
        name: "Juventude e Sociedade Contemporânea",
        topics: [
          { id: "cultura-jovem-comportamento-consumo", name: "Cultura jovem e comportamento: consumo, redes sociais e influência midiática" },
          { id: "juventude-periferica-desigualdade", name: "Juventude periférica e desigualdade" },
          { id: "educacao-trabalho-futuro", name: "Educação, trabalho e futuro" },
        ],
      },
      {
        id: "religiao-sociedade",
        name: "Religião e Sociedade",
        topics: [
          { id: "religiao-instituicao-social", name: "Religião como instituição social" },
          { id: "secularizacao-pluralismo-religioso", name: "Secularização e pluralismo religioso" },
          { id: "sincretismo-religiosidade-popular", name: "Sincretismo e religiosidade popular" },
          { id: "religiao-politica", name: "Religião e política" },
          { id: "fundamentalismo-intolerancia-religiosa", name: "Fundamentalismo e intolerância religiosa" },
        ],
      },
      {
        id: "educacao-sociedade",
        name: "Educação e Sociedade",
        topics: [
          { id: "funcao-social-escola", name: "Função social da escola" },
          { id: "desigualdade-educacional-reproducao-social", name: "Desigualdade educacional e reprodução social (Bourdieu)" },
          { id: "paulo-freire-pedagogia-critica", name: "Paulo Freire e pedagogia crítica" },
          { id: "educacao-cidadania", name: "Educação e cidadania" },
        ],
      },
      {
        id: "comunicacao-cultura-massa",
        name: "Comunicação e Cultura de Massa",
        topics: [
          { id: "meios-comunicacao-poder", name: "Meios de comunicação e poder" },
          { id: "formacao-opiniao-publica", name: "Formação da opinião pública" },
          { id: "cultura-consumo-alienacao", name: "Cultura de consumo e alienação" },
          { id: "fake-news-manipulacao", name: "Fake news e manipulação" },
          { id: "redes-sociais-comportamento-coletivo", name: "Redes sociais e comportamento coletivo" },
        ],
      },
      {
        id: "globalizacao-sociedade-pos-moderna",
        name: "Globalização e Sociedade Pós-Moderna",
        topics: [
          { id: "transformacoes-economicas-culturais-globalizacao", name: "Transformações econômicas e culturais da globalização" },
          { id: "aldeia-global-mcluhan", name: "Aldeia global (McLuhan)" },
          { id: "homogeneizacao-resistencia-cultural", name: "Homogeneização e resistência cultural" },
          { id: "individualismo-consumismo-crise-pertencimento", name: "Individualismo, consumismo e crise de pertencimento" },
        ],
      },
      {
        id: "sociologia-brasileira",
        name: "Sociologia Brasileira",
        topics: [
          { id: "formacao-sociedade-brasileira", name: "Formação da sociedade brasileira" },
          { id: "escravidao-racismo-estrutural", name: "Escravidão e racismo estrutural" },
          { id: "modernizacao-conservadora", name: "Modernização conservadora" },
          { id: "pensamento-florestan-gilberto-darcy", name: "Pensamento de Florestan Fernandes, Gilberto Freyre e Darcy Ribeiro" },
          { id: "movimentos-sociais-brasil-contemporaneo", name: "Movimentos sociais no Brasil contemporâneo" },
        ],
      },
    ],
  },
