    ...
    <>
          ...
          <div className="max-w-md mx-auto text-center space-y-6">
            ...
            <div className="bg-card border border-border rounded-xl p-4 text-left space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-center gap-2"><Crown className="h-4 w-4 text-primary flex-shrink-0" />Acesso ilimitado a todas as questões</li>
                <li className="flex items-center gap-2"><Crown className="h-4 w-4 text-primary flex-shrink-0" />Análise detalhada de desempenho</li>
                <li className="flex items-center gap-2"><Crown className="h-4 w-4 text-primary flex-shrink-0" />Identificação de pontos fracos</li>
                <li className="flex items-center gap-2"><Crown className="h-4 w-4 text-primary flex-shrink-0" />Questões de 15+ vestibulares</li>
              </ul>
            </div>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Assinar Premium</DialogTitle>
          </DialogHeader>
          <AsaasCheckoutForm onSuccess={() => setOpen(false)} />
        </DialogContent>
      </Dialog>
    </>
  );
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Assine agora e não perca seu progresso</p>
            </div>
          </div>
          <Button onClick={() => setOpen(true)} variant="default" size="sm" className="gap-2 flex-shrink-0">
